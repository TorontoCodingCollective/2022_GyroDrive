...
public class CameraSubsystem extends SubsystemBase {
	...
	public CameraSubsystem() {
        ...
        cameraFeed = CameraServer.addServer("Selected Camera");
        ...
        //        another camera.
        frontCamera = CameraServer.startAutomaticCapture("Front Camera", 1);
        ...
        rearCamera  = CameraServer.startAutomaticCapture("Rear Camera", 0);
