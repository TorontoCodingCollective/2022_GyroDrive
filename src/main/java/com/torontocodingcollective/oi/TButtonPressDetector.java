 ...
 * passed in button.
 * <p>
 * This routine will only return {@code true} on the first occurrence of a button
 * press after the button was last released. It will then return {@code false} for
