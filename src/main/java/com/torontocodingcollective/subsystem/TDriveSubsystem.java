...
public abstract class TDriveSubsystem extends TSubsystem {
	...
	protected final TMotorController leftMotorController;
	protected final TMotorController rightMotorController;
	 ...
	 *            that implements the TSpeedController interface
	 */
	public TDriveSubsystem(TMotorController leftSpeedController, TMotorController rightSpeedController) {
	...
	public TDriveSubsystem(TMotorController leftSpeedController, TMotorController rightSpeedController,
		...
		this.leftMotorController = leftSpeedController;
		this.rightMotorController = rightSpeedController;
	 ...
	 */
	public TMotorController getSpeedController(TSide side) {
	...
	public void periodic() {
		...
		if (leftEncoder != null && rightEncoder != null) {
			...
			if (speedPidsEnabled) {
				...
				leftMotorController.set(leftSpeedPid.get());
				rightMotorController.set(rightSpeedPid.get());
		...
		SmartDashboard.putNumber("Left Output", leftMotorController.get());
		SmartDashboard.putNumber("Right Output", rightMotorController.get());
	}
	...
	public void setSpeed(double leftSpeedSetpoint, double rightSpeedSetpoint) {
		...
		if (speedPidsEnabled) {
			...
			// with the setpoint.
			leftMotorController.set(leftSpeedSetpoint);
			rightMotorController.set(rightSpeedSetpoint);
	...
	/**
	 * Initialize the drive PID and constants.
	 *
	 * @param kP
	 *            Proportional gain for the motor speed pid. The speed PIDs
	 *            are displayed on the SmartDashboard and can be adjusted through
	 ...
	 *            to use to scale the encoder feedback
	 */
	public void setSpeedPid(double kP, double kI, double maxEncoderSpeed) {
